...
<script type="text/javascript">
	var _localData = {
			"root_sys":{"id":"sys","name":"统合设置",icon:"home"}
			};
	_localData["sys_1"]=	{"id":1, "name":"商圈管理", fn:function(){GotoUrl('bizcircle.do')}};
	_localData["sys_2"]=	{"id":2, "name":"推荐查询", fn:function(){GotoUrl('recomview.do') }};	
	_localData["sys_3"]=	{"id":3, "name":"NFC号管理", fn:function(){GotoUrl('nfcmanage.do') }};
	_localData["sys_9"]=	{"id":9, "name":"Ibeacon管理", fn:function(){GotoUrl('ibeacon.do') }};
	_localData["sys_10"]=	{"id":10, "name":"二维码管理", fn:function(){GotoUrl('qrmanage.do') }};
	_localData["sys_4"]=	{"id":4, "name":"市场专员管理", fn:function(){GotoUrl('marketer.do') }};
	_localData["sys_5"]=	{"id":5, "name":"手机管理", fn:function(){GotoUrl('mobilemanage.do') }};
	_localData["sys_6"]=	{"id":6, "name":"黑名单管理", fn:function(){GotoUrl('blackuser.do') }};
	_localData["sys_7"]=	{"id":7, "name":"查看评论", fn:function(){GotoUrl('parkpraise.do') }};
	_localData["sys_8"]=	{"id":8, "name":"泊车管理", fn:function(){return false }};	
	_localData["8_801"]=	{"id":801, "name":"泊车点管理", fn:function(){GotoUrl('carstops.do') }};	
	_localData["8_802"]=	{"id":802, "name":"泊车价格管理", fn:function(){GotoUrl('carstopsprice.do') }};	
	_localData["8_803"]=	{"id":803, "name":"泊车员管理", fn:function(){GotoUrl('parkattendant.do') }};
	_localData["8_804"]=	{"id":804, "name":"泊车订单", fn:function(){GotoUrl('ctorders.do') }};
