...
<div style="width:100%;float:left;height:33px;overflow:hidden;border-bottom:1px solid #ccc;">
    <div id="page-tabs"><ul>
	<li id="tag1" >
		<div></div> <a href="#" id="iframe-1" onclick="switchTag(this,'parking.do')" >停车场管理</a>
	</li>
	<li id="tag2" >
		<div></div> <a href="#" id="iframe-2" onclick="switchTag(this,'mobilemanage.do')" >手机管理</a>
	</li>
	<li id="tag3">
		<div></div> <a href="#" id="iframe-3" onclick="switchTag(this,'anlysis.do')">统计分析</a>
	</li>
        </ul>
    </div>
...
function init(){
	...
	createIframe(document.getElementById('iframe-1-div'),'iframe-1','parking.do');
