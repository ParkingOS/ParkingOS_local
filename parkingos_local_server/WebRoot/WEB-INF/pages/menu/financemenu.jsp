...
<div style="width:100%;float:left;height:33px;overflow:hidden;border-bottom:1px solid #ccc;">
    <div id="page-tabs"><ul>
     <li id="tag1">
		<div></div> <a href="#" id="iframe-1" onclick="switchTag(this,'withdraw.do?role=3')">提现管理</a>
	</li>
	<li id="tag2">
		<div></div> <a href="#" id="iframe-2" onclick="switchTag(this,'parkaccount.do?role=3')">账务管理</a>
	</li>
	<li id="tag3">
		<div></div> <a href="#" id="iframe-3" onclick="switchTag(this,'order.do?role=3')">订单管理</a>
	</li>
	<li id="tag4">
		<div></div> <a href="#" id="iframe-4" onclick="switchTag(this,'parkanlysis.do?role=3')">统计分析</a>
	</li>
        </ul>
    </div>
...
function init(){
	...
	createIframe(document.getElementById('iframe-1-div'),'iframe-1','withdraw.do?role=3');
