...
<script type="text/javascript">
	var _localData = {
			"root_sys":{"id":"sys","name":"车牌识别设置",icon:"home"}
			};
	_localData["sys_1"]=	{"id":1, "name":"工作站管理", fn:function(){GotoUrl('parkworksite.do')}};
	_localData["sys_2"]=	{"id":2, "name":"通道管理", fn:function(){GotoUrl('parkpassedit.do') }};	
