...
<script type="text/javascript">
	var _localData = {
			...
			,"sys_1":{"id":1, "name":"员工管理", fn:function(){GotoUrl('member.do?action=adminlist&comid='+parkid)}}
			...
			,"sys_5":{"id":5, "name":"收费设定", fn:function(){GotoUrl('mset.do?comid='+parkid)}}
			//,"sys_7":{"id":7, "name":"车位管理", fn:function(){GotoUrl('compark.do?comid='+parkid)}}
			,"sys_8":{"id":8, "name":"收费员端显示设定", fn:function(){GotoUrl('parksetting.do?action=parkclientset&id='+parkid)}}
			,"sys_9":{"id":9, "name":"车型管理", fn:function(){GotoUrl('cartype.do?comid='+parkid)}}
			,"sys_4":{"id":4, "name":"提现账户"}
			,"4_401":{"id":401, "name":"公司账户", fn:function(){GotoUrl('comaccount.do?comid='+parkid+'&type=0')}}
			,"4_402":{"id":402, "name":"对公账户", fn:function(){GotoUrl('comaccount.do?comid='+parkid+'&type=2')}}
			,"4_403":{"id":403, "name":"个人账户", fn:function(){GotoUrl('useraccount.do?comid='+parkid)}}
			...
			,"6_606":{"id":606, "name":"Ibeacon设置", fn:function(){GotoUrl('ibeacon.do?parkid='+parkid)}}
