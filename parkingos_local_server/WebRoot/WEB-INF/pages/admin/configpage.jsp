...
<script type="text/javascript">
	var _localData = {
			"root_sys":{"id":"sys","name":"本地服务器设置",icon:"home"}
			};
	_localData["sys_1"]=	{"id":1, "name":"参数管理", fn:function(){GotoUrl('config.do?action=query')}};
	_localData["sys_2"]=	{"id":2, "name":"密码管理", fn:function(){GotoUrl('config.do?action=editpasspage') }};	
	//_localData["sys_3"]=	{"id":3, "name":"摄像头管理", fn:function(){GotoUrl('parkcamera.do') }};	
	//_localData["sys_4"]=	{"id":4, "name":"LED屏管理", fn:function(){GotoUrl('parkled.do') }};	
