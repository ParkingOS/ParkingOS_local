...
<body id='body'>
	<div class="_top" id='top'>
		...
		<div id='mesg' style='position:absolute;color:#FFFFFF;text-align:center' >已放入${mobile}账户中&nbsp; <a href='#' class='modify' onclick='preeditphone();'>&nbsp;修改>&nbsp;</a></div>
...
getobj('mesg').style.height=parseInt(h*0.05)+'px';
...
if(data&&data.length>0){
	for(var i=0;i<data.length;i++){
		...
		if(i==data.length-1){
			...
			var gssize= parseInt(w*0.040)+'px';
			var gssize1= parseInt(w*0.030)+'px';
