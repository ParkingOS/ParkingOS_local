...
public class BluetoothService {
    ...
    //    public static final String[] items = { "澶嶄綅鎵撳嵃鏈�, "鏍囧噯ASCII瀛椾綋", "鍘嬬缉ASCII瀛椾綋", "瀛椾綋澶у皬:00","瀛椾綋澶у皬:02","瀛椾綋澶у皬:06",
//            "瀛椾綋澶у皬:11", "鍙栨秷鍔犵矖妯″紡", "閫夋嫨鍔犵矖妯″紡", "鍙栨秷鍊掔疆鎵撳嵃", "閫夋嫨鍊掔疆鎵撳嵃", "鍙栨秷榛戠櫧鍙嶆樉", "閫夋嫨榛戠櫧鍙嶆樉",
//            "鍙栨秷椤烘椂閽堟棆杞�0掳", "閫夋嫨椤烘椂閽堟棆杞�0掳","宸﹀榻�,"灞呬腑","鍙冲榻� };
    public static final byte[][] byteCommands = { { 0x1b, 0x40 },// 澶嶄綅鎵撳嵃鏈�
            { 0x1b, 0x4d, 0x00 },// 鏍囧噯ASCII瀛椾綋
            { 0x1b, 0x4d, 0x01 },// 鍘嬬缉ASCII瀛椾綋
            { 0x1d, 0x21, 0x00 },// 瀛椾綋涓嶆斁澶�
            { 0x1d, 0x21, 0x02 },// 瀹介珮鍔犲�
...
//            { 0x1d, 0x21, 0x11 },// 瀹介珮鍔犲�
            ...
            { 0x1b, 0x56, 0x00 },// 鍙栨秷椤烘椂閽堟棆杞�0掳
            { 0x1b, 0x56, 0x01 },// 閫夋嫨椤烘椂閽堟棆杞�0掳

            { 0x1b, 0x61, 0x30 },// 宸﹀榻�
            { 0x1b, 0x61, 0x31 },// 灞呬腑瀵归綈
            { 0x1b, 0x61, 0x32 },// 鍙冲榻�
//            { 0x1b, 0x69 },// 鍒囩焊
    };
